 ...
 *
 */
public class NavGuideActivity extends Activity {

	private final String TAG = NavGuideActivity.class.getName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (intent != null) {
			...
			if (bundle != null) {
				mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(NavSdkClient.ROUTE_PLAN_NODE);
			}
		}
		//显示自定义图标
		if (hd != null) {
