...
public class BaiduMapModule extends ReactContextBaseJavaModule {
    ...
    //zhoujw add
    private static int heightOfStatubarAndToolbar = 0;

    public static int getHeightOfStatubarAndToolbar(){
        Log.e("zdebug","getHeightOfStatubarAndToolbar:"+heightOfStatubarAndToolbar);
        return heightOfStatubarAndToolbar;
    }

    @ReactMethod
    public void setHeightOfStatuAndToolbar(int height){
        heightOfStatubarAndToolbar = height;
    }
    //end
